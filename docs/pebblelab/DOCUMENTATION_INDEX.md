...
| [`CIV_47_PHASE_SUMMARY.md`](CIV_47_PHASE_SUMMARY.md) | Local review candidate for sparse per-individual cultural practices, causal variation/rejection/decline, derived settlement prevalence, schema-42 restart/replay and two-settlement divergence; not published and Gate G unevaluated. |
