...
active phase: none; Gate F Evaluation 02 is the next independent action
...
acquired. Evaluation 02 is not performed, and the next authorized action is
`NEW-INDEPENDENT-V4-GATE-F-v1-EVALUATION-02`. `CIV-38`
