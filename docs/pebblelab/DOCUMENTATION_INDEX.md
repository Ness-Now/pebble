...
| [`CIV_46_PHASE_SUMMARY.md`](CIV_46_PHASE_SUMMARY.md) | Senior-review-approved, not-published CIV-46 candidate: bounded metadata-only catalogues and reconstructed indexes over CIV-45 material carriers, with release, restart/loss/rebuild/replay proofs and two-seed live evidence. |
...
historical evidence. CIV-46 is implemented, tested and externally senior-review
approved, but is not published; CIV-47 remains unstarted. Gate G remains
