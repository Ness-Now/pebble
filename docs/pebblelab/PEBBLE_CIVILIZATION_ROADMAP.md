...
next authorized action: REVIEW AND AUTHORIZE CIV-46; IMPLEMENTATION REMAINS UNAUTHORIZED
...
and independent remote verification are complete. CIV-46 and CIV-47 remain
unstarted; review and authorization of CIV-46 is next, but implementation is
not authorized. Gate G remains
...
CIV-46 and CIV-47 remain unstarted; review and authorization of CIV-46 is next,
but implementation is not authorized. Gate G remains planned and unevaluated.
...
`CIV-46` and `CIV-47` remain unstarted. Review and authorization of CIV-46 is
next; implementation remains unauthorized. Gate G remains planned and has not
been evaluated.
