...
remote SHA verification. `CIV-40` remains optional tooling and not started;
`CIV-41` is not started and becomes the next authorized action after that
publication. Gate G remains planned.
...
CIV-39 published canonical HEAD: 0b0ec535cda62b70add182875c65eaee27bb5bb2
Gate F local status: ACQUIRED_PUBLICATION_CANDIDATE — AWAITING USER PUSH
Gate F status after manual push and independent remote SHA verification: ACQUIRED AND PUBLISHED
...
Gate F is locally **ACQUIRED_PUBLICATION_CANDIDATE — AWAITING USER PUSH** and
becomes **ACQUIRED AND PUBLISHED** only after manual push and independent
remote SHA verification. CIV-40 remains optional tooling and is not a
prerequisite; CIV-41 is not started and is the next eligible required phase
after acquisition publication. Gate G remains planned.
