...
`d7fac42493b229ce36ece5c21c597284e5ad7cb5`. Evaluation 05 is not performed,
and `CIV-40` remains optional tooling and not started.
...
Gate F Evaluation 05 status: NOT PERFORMED
...
Gate F remains not acquired. Evaluation 05 is not performed. The next
authorized required action is
`NEW-INDEPENDENT-V4-GATE-F-v1-EVALUATION-05`. CIV-40 remains optional tooling
...
| `V4-GATE-F-v1` | planned, not acquired | required `CIV-39` complete/published/remote-verified; Evaluations 01–04 historical FAIL; Blockers 01–04 fixed/published/remote-verified; Evaluation 05 not performed and next authorized; `CIV-40` optional tooling and not started |
