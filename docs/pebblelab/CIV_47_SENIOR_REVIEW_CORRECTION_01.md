...
Correction 01 status: LOCAL REVIEW CANDIDATE / NOT PUBLISHED
Gate G: PLANNED / UNEVALUATED / NOT ACQUIRED
```

This document records a new candidate for independent senior re-review. It
does not alter the original verdict and does not claim senior approval,
publication or remote verification.
...
Final candidate identity and review ZIP identity are recorded in the external
review bundle manifest because a commit cannot contain its own SHA.
