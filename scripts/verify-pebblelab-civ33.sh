...
PHASE2_COMMANDS='/tp 14 66 -21|/lab start;/lab pause;/lab movement off;/lab follow off;/lab overlay full;/lab checkpoint load civ33-open;/lab persistence-reconciliation status;/lab estates status;/lab observer open;/lab observer global;/lab observer status;/lab causality tail 20;/tp 18 71 -14 135 24|/lab estates settle latest next;/lab estates status;/lab persistence-reconciliation status;/lab observer select agent_1;/lab observer status;/lab causality tail 20;/tp 18 71 -14 135 24|/lab checkpoint save civ33-settled;/lab checkpoint status;/lab observer close;/lab estates proof cleanup;/lab checkpoint delete civ33-open;/lab checkpoint delete civ33-settled;/lab checkpoint status;/lab estates status;/lab status'
