...
func prepareScenario(_ options: Options, world: World) -> ScenarioResult {
    ...
    switch scenario {
    case "terrain_semantics_fixture_smoke", "terrain_traversability_fixture_smoke", "terrain_pathfinding_fixture_smoke", "terrain_pathfinding_column_positive_smoke", "terrain_path_live_movement_smoke", "terrain_path_movement_fixture_smoke", "terrain_collision_fixture_smoke", "route_following_fixture_smoke", "route_following_live_hardening_smoke", "multi_agent_movement_fixture_smoke", "multi_agent_movement_fixture_hardening_smoke":
