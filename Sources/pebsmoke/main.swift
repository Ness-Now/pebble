...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "ps01-increment-03-performance" {
    registerAllBlocks()
    registerAllItems()
    registerAllEntities()
    registerAllSystems()
    runPebbleCorePhysicalSimulationCoveragePerformanceSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "ps01-increment-02" {
    runPebbleAgentsTerminalPopulationContinuitySmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"] == "founder-bootstrap" {
    runPebbleAgentsFounderBootstrapSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-g-evaluation-02" {
    registerAllBlocks(); registerAllItems(); registerAllEntities(); registerAllSystems()
    runPebbleAgentsGateGEvaluation02Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-g-evaluation-02-restart-read" {
    runPebbleAgentsGateGEvaluation02RestartReadSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-g-blocker-01" {
    runPebbleAgentsGateGBlocker01Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "civ-45-correction09" {
    runPebbleAgentsPopulationConfigurationCorrection09Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "civ-45-persistent-identity" {
    registerAllBlocks(); registerAllItems(); registerAllEntities(); registerAllSystems()
    runPebbleCoreWritingPersistentIdentitySmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "civ-45-correction03" {
    registerAllBlocks(); registerAllItems(); registerAllEntities(); registerAllSystems()
    runPebbleAgentsWritingAuthorityFinalizationCorrection03Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "civ-45-correction05" {
    registerAllBlocks(); registerAllItems(); registerAllEntities(); registerAllSystems()
    runPebbleCorePersistenceCorrection05Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "civ-45-correction06" {
    registerAllBlocks(); registerAllItems(); registerAllEntities(); registerAllSystems()
    runPebbleCorePersistenceCorrection06Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "civ-45-correction08-appkit-reader" {
    registerAllBlocks(); registerAllItems(); registerAllEntities(); registerAllSystems()
    runPebbleCorePersistenceCorrection08AppKitReader()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"] == "civ-47" {
    runPebbleAgentsCultureSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "civ-43-restart-read" {
    runPebbleAgentsOralTransmissionRestartReadSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"] == "civ-43" {
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "civ-42-restart-write" {
    runPebbleAgentsLanguageRestartWriteSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "civ-42-restart-read" {
    runPebbleAgentsLanguageRestartReadSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"] == "civ-42" {
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"] == "barter" {
    runPebbleAgentsBarterSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"] == "contracts" {
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-e-blocker-01" {
    runPebbleAgentsExactProductionProvenanceSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-e-blocker-02" {
    runPebbleAgentsEvolvedProductionIdentitySmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-e-blocker-03" {
    runPebbleAgentsGateEBlocker03Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-blocker-02" {
    runPebbleAgentsGateFBlocker02Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-blocker-04" {
    runPebbleAgentsGateFBlocker04Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-blocker-08" {
    runPebbleAgentsGateFBlocker08Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-blocker-09" {
    runPebbleAgentsGateFBlocker09Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-blocker-10" {
    runPebbleAgentsGateFBlocker10Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-blocker-11" {
    runPebbleAgentsGateFBlocker11Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-evaluation-12-attack-02" {
    runPebbleAgentsGateFEvaluation12Attack02Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-evaluation-12-attack-03" {
    runPebbleAgentsGateFEvaluation12Attack03Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-evaluation-12-attack-04" {
    registerAllBlocks()
    registerAllItems()
    registerAllEntities()
    registerAllSystems()
    runPebbleAgentsGateFEvaluation12Attack04Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-evaluation-12-attack-05" {
    runPebbleAgentsGateFEvaluation12Attack05Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-evaluation-12-attack-06" {
    runPebbleAgentsGateFEvaluation12Attack06Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}

if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "gate-f-evaluation-12-attack-07" {
    runPebbleAgentsGateFEvaluation12Attack07Smoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"] == "social" {
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"] == "homeostasis-health" {
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"] == "construction" {
    registerAllBlocks()
    registerAllItems()
    registerAllEntities()
    registerAllSystems()
    runPebbleCorePhysicalActionSmoke()
    runPebbleAgentsConstructionPublicationSmoke()
    print("\n\(passed) passed, \(failed) failed")
    exit(failed > 0 ? 1 : 0)
}
...
if ProcessInfo.processInfo.environment["PEBBLELAB_SMOKE_ONLY"]
    == "autonomous-interaction-retry-liveness" {
