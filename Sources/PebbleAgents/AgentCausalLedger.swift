...
public enum AgentCausalEventKind: String, Codable, CaseIterable, Sendable {
    ...
    case settlementMigrationFailed
    ...
    case geneticsInitialized
    case founderGenotypeAssigned
    case genotypeInherited
    case developmentChanged
    case phenotypeChanged
    case familyV1Initialized
    case familyInteractionVerified
    case unionProposed
    case unionAccepted
    case unionActivated
    case unionEnded
    case lineageFounded
    case houseFounded
    case houseMemberJoined
    case houseMemberLeft
    case estatesInitialized
    case estateOpened
    case estateAdministratorNominated
    case estateAdministratorAccepted
    case estateAdministratorEnded
    case estateSuccessorPlanCreated
    case estateAssetClassified
    case estateAssetBlocked
    case estateAssetTransferStarted
    ...
    case barterInitialized
    case barterOpportunityObserved
    case barterOfferCreated
...
public struct AgentCausalEvent: Codable, Equatable, Sendable {
    ...
    public static func validate(
        ...
        case (.sessionLifecycle, .lifecycle), (.tickCompleted, .lifecycle),
             ...
             (.settlementMigrationFailed, .operation),
             ...
             (.geneticsInitialized, .operation),
             (.founderGenotypeAssigned, .operation),
             (.genotypeInherited, .operation),
             (.developmentChanged, .operation),
             (.phenotypeChanged, .operation),
             (.familyV1Initialized, .operation),
             (.familyInteractionVerified, .operation),
             (.unionProposed, .operation),
             (.unionAccepted, .operation),
             (.unionActivated, .operation),
             (.unionEnded, .operation),
             (.lineageFounded, .operation),
             (.houseFounded, .operation),
             (.houseMemberJoined, .operation),
             (.houseMemberLeft, .operation),
             (.estateOpened, .operation),
             (.estateAdministratorNominated, .operation),
             (.estateAdministratorAccepted, .operation),
             (.estateAdministratorEnded, .operation),
             (.estateSuccessorPlanCreated, .operation),
             (.estateAssetClassified, .operation),
             (.estateAssetBlocked, .operation),
             (.estateAssetTransferStarted, .operation),
             ...
             (.barterInitialized, .feature),
             (.barterOpportunityObserved, .operation),
